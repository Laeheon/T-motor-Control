...
void Torque_Control(uint8_t driver_id, int Kp_value, int Kd_value, double Current_value); 
double Receive_current_torque();
double Receive_current_position();
double Receive_current_speed();
double Position_Control_PD(uint8_t driver_id, double Current_value);
double initial_position;
double received_position_position_PD;
double received_speed_position_PD;
